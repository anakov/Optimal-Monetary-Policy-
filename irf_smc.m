...
figure(2)
subplot(3,3,1)
plot(100*oo_.irfs.cp_shock_ucp','r:')
title('Cost push shock')
legend boxoff
hold on

subplot(3,3,8)
plot(100*oo_.irfs.pi_ucp,'r:')
title('Inflation')
xlabel('Quarters')
hold on

subplot(3,3,3)
plot(100*(oo_.irfs.y_ucp'-yfp_ucp'))
title('Output gap')
hold on

plot(100*oo_.irfs.r_ucp,'r:')
title('Nominal interest rate')
hold on

subplot(3,3,7)
plot(100*oo_.irfs.pstar_ucp,'r:')
title('Optimal price')
xlabel('Quarters')
hold on

subplot(3,3,9)
plot(100*oo_.irfs.Delta_ucp,'r:')
title('Price dispersion')
hold on

subplot(3,3,2)
plot(100*(oo_.irfs.r_ucp(1:end-1)-oo_.irfs.pi_ucp(2:end)),'r:')
title('Real interest rate')
hold on

subplot(3,3,4)
plot(100*oo_.irfs.c_ucp/c,'r:')
title('Consumption')
hold on

subplot(3,3,5)
plot(100*oo_.irfs.n_ucp/n,'r:')
title('Hours worked')
hold on

subplot(3,3,6)
plot(100*oo_.irfs.w_ucp/w,'r:')
title('Real wage')
hold on
